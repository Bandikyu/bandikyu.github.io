...
if(finalTrimestre>1) {
    vaca.innerHTML = `RECORDATORIO: faltan <span>${finalTrimestre} dias</span> para que termine el 3º trimestre`;
}else if(finalTrimestre===1) {
    vaca.innerHTML = `RECORDATORIO: falta <span>${finalTrimestre} dia</span> para que termine el 3º trimestre`;
